                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary">
                                    <input type="text" name="github" class="form-control" value={{ $urls['github']->url }}>
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary">
                                    <input type="text" name="twitter" class="form-control" value={{ $urls['twitter']->url }}>
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-monitor mr-2 icon-inline">
                                ...
                                <span class="text-secondary">
                                    <input type="text" name="website" class="form-control" value={{ $urls['website']->url }}>
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="career" class="form-select form-select-lg col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="other" class="form-control" value={{$urls['other']->url}}>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
